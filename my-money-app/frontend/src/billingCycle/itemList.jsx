    ...
    renderRows() {
        ...
        return list.map(
            (item, index) => (
                <tr key={index}>
                    <td>
                        <Field name={`${this.props.field}[${index}].name`} placeholder='Informe o nome' readOnly={this.props.readOnly}
                            component={Input} />
                    </td>
                    <td>
                        <Field name={`${this.props.field}[${index}].value`} placeholder='Informe o valor' readOnly={this.props.readOnly}
                            component={Input} />
                    </td>
                    <If rendered={this.props.showStatus}>
                        <td>
