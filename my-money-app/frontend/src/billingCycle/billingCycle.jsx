...
import { create, update, excluir } from './billingCycleAction'
...
const mapDispatchToProps = (dispatch) => bindActionCreators({ selectTab, showTabs, create, update, excluir }, dispatch)
