    ...
    const keyHandler = e => {
     ...
     return   (
        ...
        <Grid xs='12' sm='3' md='2'>
            <Button icon='search' rendered={true} styled='info' handleAction={props.handleSearch} />
            <Button icon='plus' rendered={true} styled='primary' handleAction={props.handleAdd} />
            <Button icon='close' rendered={true} styled='default' handleAction={props.handleClear} />
        </Grid>
         </div>
        )
}